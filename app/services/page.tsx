        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-300 dark:text-black p-6 rounded-lg shadow-lg">
              ...
              <a href='https://api.whatsapp.com/send?phone=+523318444445&text=Hola, Cotizar Clases de Programación' className="mt-6 inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold px-4 py-2 rounded-full">Solicitar</a>
            </div>
            ...
            <div className=" p-6 rounded-lg shadow-lg bg-gradient-to-r from-indigo-500 to-indigo-800">
              ...
              <a href='https://api.whatsapp.com/send?phone=+523318444445&text=Hola, Cotizar Desño Web' className="mt-6 inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold px-4 py-2 rounded-full">Solicitar</a>
            </div>
          </div>
        </div>
      </section>
